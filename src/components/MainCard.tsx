...
const MainCard = () => {
  ...
  return (
    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl shadow-lg p-4 sm:p-6 w-full max-w-2xl text-white mx-auto overflow-hidden">
      {/* Titulo */}
      ...
      {/* Contador */}
      <div className="flex justify-between flex-wrap text-center gap-y-2 text-xs sm:text-sm font-medium">
        {[
